...
<COWORK>/direito-familia/.snapshots/pre-compact-<timestamp>.md.
...
def _collect_memories(cowork: Path) -> list[tuple[str, Path]]:
    ...
    # Areas: primeiro nivel de subpastas (exclui direito-familia e dot-dirs)
...
def main() -> int:
    ...
    snapshots_dir = cowork / "direito-familia" / ".snapshots"
