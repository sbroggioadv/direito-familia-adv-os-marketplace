...
<COWORK>/direito-familia/.memory-evolver-pending.json. A SKILL `memory-evolver` e a que
...
def main() -> int:
    ...
    state_file = cowork / "direito-familia" / "cowork-state.json"
    ...
    pending_path = cowork / "direito-familia" / ".memory-evolver-pending.json"
